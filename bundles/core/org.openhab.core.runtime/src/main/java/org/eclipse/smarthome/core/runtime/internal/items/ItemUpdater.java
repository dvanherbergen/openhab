...
/**
 * The ItemUpdater listens on the event bus and passes any received status
 * update to the item registry.
 * 
 * @author Kai Kreuzer
 * @since 0.1.0
 * 
...
public class ItemUpdater implements EventSubscriber {
	...
	public void receiveCommand(String itemName, Command command) {
		// if the item is a group, we have to pass the command to it as it needs
		// to pass the command to its members
		if (itemRegistry != null) {
			try {
